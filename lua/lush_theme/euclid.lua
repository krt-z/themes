...
local light_blue = hsl(204, 59, 70)
local red = hsl(2, 61, 69)
...
local theme = lush(function()
  return {
    ...
    -- Comment      { fg=light_blue.darken(25) }, -- any comment
    ...
    Normal       { bg = bg, fg = beige }, -- normal text
    ...
    Type           { fg = gold }, -- (preferred) int, long, char, etc.
